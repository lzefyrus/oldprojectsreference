...
from integrations.nextel.v1.services import backend as BackendService
from integrations.nextel.v1.validators.backend import validate_signature, validate_cancellation, validate_mt, \
    validate_billing
import logging
import tornado.gen
...
class SignatureHandler(APIHandler):
    ...
    def post(self):
        try:
            ...
            la = body['la']
            msisdn = body['msisdn']
            double_option = utils.str2bool(body['double-option'])
        ...
        try:
            ...
            try:
                ...
                response_code = 500
            log.error("Could not access nextel service. "
                      "Request URL: {0}."
                      "Request Headers: {1}."
                      "Request Body: {2}."
                      "Error: {3}."
            ...
            return self.error({"message": "Could not access the nextel service: {0}".format(httpe), "success": 0}, response_code)
            ...
            return self.error({"message": "Could not access the nextel service: {0}".format(e), "success": 0}, 500)
    ...
    def post(self):
        ...
        try:
            ...
            try:
                ...
                response_code = 500
            log.error("Could not access the nextel service. "
                      "Request URL: {0}."
                      "Request Headers: {1}."
                      "Request Body: {2}."
                      "Error: {3}."
            ...
            log.error("Could not access the nextel service: {0}."
                      "Operation Hash: {1}."
                      .format(e, self.CANCELLATION_HASH))
            return self.error({"message": "Could not access the nextel service: {0}".format(e), "success": 0}, 500)
...
class BillingHandler(APIHandler):
    ...
    def post(self):
        try:
            ...
            log.error("Internal Server Error. "
                      "Error: {0}."
                      "Operation Hash: {1}.".format(e, self.BILLING_HASH))
            return self.error({"message": "Internal Server Error", "success": 0}, 500)
