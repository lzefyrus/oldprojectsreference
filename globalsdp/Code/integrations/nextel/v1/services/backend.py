...
class SignatureService(object):
    ...
    def get_configs(self, settings, la):
        ...
        return {
            'host': settings['config']['nextel/v1/host']['value'],
            'url': settings['config']['nextel/v1/signature/url']['value'],
            'company_id': settings['config']['nextel/v1/company/id']['value'],
            'operation_code': settings['config']['nextel/v1/signature/code']['value'],
            'operation_description': settings['config']['nextel/v1/signature/description']['value'],
            'auth_type': settings['config']['nextel/v1/signature/auth/type']['value'],
            'notification_type': settings['config']['nextel/v1/signature/notification/type']['value'],
            'notification_calltype': settings['config']['nextel/v1/signature/notification/calltype']['value'],
            'notification_callback': settings['config']['nextel/v1/signature/notification/callback']['value'],
            'user': settings['config']['nextel/v1/{0}/user'.format(la)]['value'],
            'password': settings['config']['nextel/v1/{0}/password'.format(la)]['value'],
            'service_id': settings['config']['nextel/v1/{0}/service-id'.format(la)]['value'],
        }
    ...
    def get_body(self, configs, channel_id, la, msisdn, app_specific, interface, subscription_type, double_option):
        """
        ...
        :param double_option: Double optin or not
        :return: xml
        """
    ...
    def parse_response_to_json(self, xml_response):
        """
        Parses Nextel's xml response to json
...
class CancellationService(object):
    ...
    def get_configs(self, settings, la):
        ...
        return {
            'host': settings['config']['nextel/v1/host']['value'],
            'url': settings['config']['nextel/v1/cancellation/url']['value'],
            'company_id': settings['config']['nextel/v1/company/id']['value'],
            'operation_code': settings['config']['nextel/v1/cancellation/code']['value'],
            'operation_description': settings['config']['nextel/v1/cancellation/description']['value'],
            'user': settings['config']['nextel/v1/{0}/user'.format(la)]['value'],
            'password': settings['config']['nextel/v1/{0}/password'.format(la)]['value'],
            'service_id': settings['config']['nextel/v1/{0}/service-id'.format(la)]['value'],
            'notification_type': settings['config']['nextel/v1/cancellation/notification/type']['value'],
            'notification_calltype': settings['config']['nextel/v1/cancellation/notification/calltype']['value'],
            'notification_callback': settings['config']['nextel/v1/cancellation/notification/callback']['value'],
        }
...
class MtService(object):
    ...
    def get_configs(self, settings, la):
        ...
        return {
            'host': settings['config']['nextel/v1/host']['value'],
            'url': settings['config']['nextel/v1/mt/url']['value'],
            'company_id': settings['config']['nextel/v1/company/id']['value'],
            'keep_session': settings['config']['nextel/v1/mt/keepsession']['value'],
            'notification_type': settings['config']['nextel/v1/mt/notification/type']['value'],
            'notification_calltype': settings['config']['nextel/v1/mt/notification/calltype']['value'],
            'notification_callback': settings['config']['nextel/v1/mt/notification/callback']['value'],
            'user': settings['config']['nextel/v1/{0}/user'.format(la)]['value'],
            'password': settings['config']['nextel/v1/{0}/password'.format(la)]['value'],
            'service_id': settings['config']['nextel/v1/{0}/service-id'.format(la)]['value'],
        }
...
class BillingService(object):
    ...
    def get_configs(self, settings, la):
        ...
        return {
            'host': settings['config']['nextel/v1/host']['value'],
            'url': settings['config']['nextel/v1/billing/url']['value'],
            'company_id': settings['config']['nextel/v1/company/id']['value'],
            'operation_code': settings['config']['nextel/v1/billing/code']['value'],
            'operation_description': settings['config']['nextel/v1/billing/description']['value'],
            'transaction_type': settings['config']['nextel/v1/billing/transaction/type']['value'],
            'transaction_description': settings['config']['nextel/v1/billing/transaction/description']['value'],
            'user': settings['config']['nextel/v1/{0}/user'.format(la)]['value'],
            'password': settings['config']['nextel/v1/{0}/password'.format(la)]['value'],
            'service_id': settings['config']['nextel/v1/{0}/service-id'.format(la)]['value'],
        }
...
def response_has_errors(response_content):
    """
    Checks if Nextel's response contains some error message or Bad Request
